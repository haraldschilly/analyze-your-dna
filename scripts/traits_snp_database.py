...
TRAITS_SNPS = {
    ...
    "rs12913832": {
        ...
        "category": "Eye Color",
        "variants": {
            "GG": {"status": "blue", "desc": "Blue eyes - HERC2 enhancer inactive, OCA2 expression suppressed", "magnitude": 0},
            "AG": {"status": "intermediate", "desc": "Green/Hazel eyes - heterozygous, intermediate melanin production", "magnitude": 1},
            "GA": {"status": "intermediate", "desc": "Green/Hazel eyes - heterozygous, intermediate melanin production", "magnitude": 1},
            "AA": {"status": "brown", "desc": "Brown eyes - full OCA2 expression, high melanin in iris", "magnitude": 0},
        },
    ...
    "rs1800407": {
        ...
        "category": "Eye Color",
        "variants": {
            "AA": {"status": "lightening", "desc": "Lightening effect - Arg419Gln reduces melanin, shifts hazel→green/blue", "magnitude": 1},
            ...
            "GG": {"status": "darkening", "desc": "No lightening - ancestral allele, darker pigmentation", "magnitude": 0},
        },
    ...
    "rs12896399": {
        ...
        "category": "Eye Color",
        "variants": {
            "TT": {"status": "lighter", "desc": "Lighter iris pigmentation - associated with lighter blue/grey shades", "magnitude": 0},
    ...
    "rs12203592": {
        ...
        "category": "Eye Color",
        "variants": {
            "TT": {"status": "light", "desc": "Lighter eyes, freckles, premature graying - inhibits tyrosinase", "magnitude": 1},
    ...
    "rs1805007": {
        ...
        "category": "Hair Color",
        "variants": {
            "TT": {"status": "red_hair", "desc": "Red hair allele (Arg151Cys) - two copies likely produces red/ginger hair", "magnitude": 2},
            "TC": {"status": "carrier", "desc": "Red hair carrier - may have auburn highlights or reddish beard", "magnitude": 1},
            "CT": {"status": "carrier", "desc": "Red hair carrier - may have auburn highlights or reddish beard", "magnitude": 1},
    ...
    "rs1805008": {
        ...
        "category": "Hair Color",
        "variants": {
            "TT": {"status": "red_hair", "desc": "Red hair allele (Arg160Trp) - strong red hair effect", "magnitude": 2},
    ...
    "rs1805009": {
        ...
        "category": "Hair Color",
        "variants": {
            "TT": {"status": "red_hair", "desc": "Red hair allele (Asp294His) - strong red hair effect", "magnitude": 2},
            "TC": {"status": "carrier", "desc": "Red hair carrier", "magnitude": 1},
            "CT": {"status": "carrier", "desc": "Red hair carrier", "magnitude": 1},
            "CC": {"status": "normal", "desc": "No red hair variant at this locus", "magnitude": 0},
        },
    ...
    "rs12821256": {
        ...
        "category": "Hair Color",
        "variants": {
            "AA": {"status": "blonde", "desc": "Strong blonde driver - AA + light SLC45A2 = platinum/ash blonde", "magnitude": 1},
    ...
    "rs1426654": {
        ...
        "category": "Skin Tone",
        "variants": {
            "AA": {"status": "pale", "desc": "Light skin (A111T) - nearly fixed in Europeans, major depigmentation allele", "magnitude": 0},
    ...
    "rs6119471": {
        ...
        "category": "Skin Tone",
        "variants": {
            "AA": {"status": "lighter", "desc": "Lighter skin - agouti signaling increases pheomelanin", "magnitude": 0},
    ...
    "rs713598": {
        ...
        "variants": {
            "CC": {"status": "taster_PAV", "desc": "PAV haplotype component - can taste PTC/PROP bitterness", "magnitude": 1},
    ...
    "rs72921001": {
        ...
        "variants": {
            "CC": {"status": "aversion", "desc": "High cilantro aversion - perceives soapy/chemical taste from aldehydes", "magnitude": 1},
    ...
    "rs1332938": {
        ...
        "variants": {
            "AA": {"status": "cannot_smell", "desc": "Asparagus anosmia - cannot smell methanethiol in urine", "magnitude": 0},
    ...
    "rs35744813": {
        ...
        "variants": {
            "CC": {"status": "higher", "desc": "Lower sweet receptor sensitivity - may prefer higher sugar concentrations", "magnitude": 1},
    ...
    "rs12878143": {
        ...
        "category": "Sweet Preference",
        "variants": {
            "TT": {"status": "sweet_tooth", "desc": "Sweet tooth - impaired glucose sensing may drive higher sugar intake", "magnitude": 1},
            ...
            "CC": {"status": "low_preference", "desc": "Lower sweet preference - may prefer savory flavors", "magnitude": 0},
        },
    ...
    "rs41380347": {
        ...
        "variants": {
            "GG": {"status": "tolerant", "desc": "Lactose persistent (East African variant) - can digest lactose in adulthood", "magnitude": 0},
            ...
            "TT": {"status": "intolerant", "desc": "Lactose non-persistent - reduced lactase after weaning", "magnitude": 0},
        },
    ...
    "rs11803731": {
        ...
        "variants": {
            "TT": {"status": "straight", "desc": "Straight hair - trichohyalin structure favors straight shaft", "magnitude": 0},
    ...
    "rs3827760": {
        ...
        "category": "Hair Texture",
        "variants": {
            "GG": {"status": "thick_straight", "desc": "Thick, coarse, straight hair - V370A gain-of-function (East Asian)", "magnitude": 0},
    ...
    "rs17822931": {
        ...
        "variants": {
            "GG": {"status": "wet", "desc": "Wet, sticky earwax - functional transporter, typical body odor", "magnitude": 0},
            "GA": {"status": "wet", "desc": "Wet earwax - dominant trait", "magnitude": 0},
            "AG": {"status": "wet", "desc": "Wet earwax - dominant trait", "magnitude": 0},
            "AA": {"status": "dry", "desc": "Dry, flaky earwax - non-functional transporter, minimal body odor", "magnitude": 0},
        },
    ...
    "rs6152": {
        ...
        "variants": {
            "GG": {"status": "high_risk", "desc": "High risk - androgen receptor more sensitive to DHT", "magnitude": 2},
    ...
    "rs1160312": {
        ...
        "category": "Male Pattern Baldness",
        "variants": {
            "AA": {"status": "high_risk", "desc": "High risk - 1.6x increased risk, 7x when combined with AR risk", "magnitude": 2},
    ...
    "rs7787362": {
        ...
        "variants": {
            "CC": {"status": "high_risk", "desc": "Higher risk - reduced elastin, less skin elasticity", "magnitude": 1},
    ...
    "rs2045323": {
        ...
        "category": "Nose Shape",
        "variants": {
            "AA": {"status": "upturned", "desc": "More upturned nasal tip - greater columella inclination", "magnitude": 0},
    ...
    "rs6184": {
        ...
        "category": "Chin/Jaw",
        "variants": {
            "AA": {"status": "prominent", "desc": "Prominent chin/prognathism - growth hormone receptor variant", "magnitude": 0},
    ...
    "rs9852899": {
        ...
        "category": "Unibrow",
        "variants": {
            "TT": {"status": "likely", "desc": "Higher likelihood of synophrys (unibrow) - melanocytes migrate to nasal bridge", "magnitude": 0},
    ...
    "rs6060373": {
        ...
        "category": "Height",
        "variants": {
            "GG": {"status": "shorter", "desc": "Shorter tendency - GDF5 affects cartilage in limb joints", "magnitude": 1},
    ...
    "rs1421085": {
        ...
        "category": "BMI/Weight",
        "variants": {
            "TT": {"status": "obesity_risk", "desc": "Higher BMI risk - FTO variant, similar effect to rs9939609", "magnitude": 2},
    ...
    "rs314277": {
        ...
        "variants": {
            "AA": {"status": "higher_ratio", "desc": "Higher 2D:4D ratio (longer index) - lower prenatal testosterone", "magnitude": 0},
            ...
            "GG": {"status": "lower_ratio", "desc": "Lower 2D:4D ratio (longer ring) - higher prenatal testosterone", "magnitude": 0},
        },
    ...
    "rs10427255": {
        ...
        "variants": {
            "CC": {"status": "likely", "desc": "Photic sneeze reflex likely - sneezes from bright light (ACHOO syndrome)", "magnitude": 1},
    ...
    "rs1868790": {
        ...
        "category": "Misophonia",
        "variants": {
            "AA": {"status": "high_risk", "desc": "Higher risk of misophonia - rage at repetitive sounds (chewing, breathing)", "magnitude": 1},
    ...
    "rs1800544": {
        ...
        "category": "Motion Sickness",
        "variants": {
            "GG": {"status": "susceptible", "desc": "High motion sickness susceptibility - nausea and vomiting during motion", "magnitude": 2},
    ...
    "rs3057": {
        ...
        "variants": {
            "CT": {"status": "potential", "desc": "Genetic potential for absolute pitch (requires early musical training ages 3-6)", "magnitude": 1},
            "TC": {"status": "potential", "desc": "Genetic potential for absolute pitch (requires early musical training ages 3-6)", "magnitude": 1},
    ...
    "rs8176719": {
        ...
        "category": "Blood Type",
        "variants": {
            "DD": {"status": "O_deletion", "desc": "Type O - frameshift deletion, no functional transferase", "magnitude": 0},
            "DI": {"status": "one_functional", "desc": "One functional ABO allele (A or B determined by rs8176746)", "magnitude": 0},
            "ID": {"status": "one_functional", "desc": "One functional ABO allele (A or B determined by rs8176746)", "magnitude": 0},
            "II": {"status": "both_functional", "desc": "Both alleles functional (A, B, or AB determined by rs8176746)", "magnitude": 0},
            ...
            "I-": {"status": "one_functional", "desc": "One functional allele", "magnitude": 0},
            "GG": {"status": "both_functional", "desc": "Both alleles functional (alternative notation)", "magnitude": 0},
    ...
    "rs8176746": {
        ...
        "variants": {
            ...
            "GT": {"status": "type_AB_or_A_B", "desc": "A/B heterozygous - Type AB if both functional, A or B if one O", "magnitude": 0},
            "TG": {"status": "type_AB_or_A_B", "desc": "A/B heterozygous - Type AB if both functional, A or B if one O", "magnitude": 0},
    ...
    "rs524952": {
        ...
        "category": "Myopia",
        "variants": {
            "AA": {"status": "myopia_risk", "desc": "Higher myopia (nearsightedness) risk - longer axial eye length", "magnitude": 2},
            ...
            "TT": {"status": "hyperopia_tendency", "desc": "Lower myopia risk / hyperopia (farsightedness) tendency", "magnitude": 0},
        },
    ...
    "rs8027411": {
        ...
        "category": "Myopia",
        "variants": {
            "TT": {"status": "high_myopia_risk", "desc": "High myopia risk - strong association with severe nearsightedness", "magnitude": 2},
    ...
    "rs1061170": {
        ...
        "category": "AMD Risk",
        "variants": {
            "CC": {"status": "high_risk", "desc": "High AMD risk - 7.4x increased risk, His402 impairs complement regulation", "magnitude": 3},
            ...
            "TT": {"status": "protective", "desc": "Protective - Tyr402, normal complement factor H function", "magnitude": 0},
        },
    ...
    "rs4656461": {
        ...
        "variants": {
            "GG": {"status": "high_risk", "desc": "Higher glaucoma risk - elevated intraocular pressure (IOP)", "magnitude": 2},
