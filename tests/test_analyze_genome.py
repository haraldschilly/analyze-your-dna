...
def test_analyze_genome_reverse_complement(mock_clinvar_data, mock_pharmgkb_data):
    ...
    mock_genome = {
        "rs999": {"chromosome": "2", "position": "300", "genotype": "TT"}
    }
    ...
    mock_curated = {
        "rs999": {
            ...
            "category": "Test",
            "variants": {
                "AA": {"status": "rev_match", "desc": "Matched reverse", "magnitude": 1}
            }
        }
    }
    ...
    mock_genome_flip = {
        "rs888": {"chromosome": "3", "position": "400", "genotype": "GA"}
    }
    mock_curated_flip = {
        "rs888": {
            "gene": "FLIP",
            "category": "Test",
            "variants": {
                "AG": {"status": "flip_match", "desc": "Matched flip", "magnitude": 1}
            }
        }
    }
