...
CLINVAR_CONTENT = "\t".join([
    "chrom", "pos", "symbol", "ref", "alt", "clinical_significance",
    "review_status", "gold_stars", "all_traits", "inheritance_modes", "hgvs_c", "hgvs_p"
]) + "\n" + "\t".join([
    "1", "100", "TEST1", "A", "G", "pathogenic",
    "criteria", "1", "Disease A", "AD", "c.100A>G", "p.Lys100Glu"
]) + "\n" + "\t".join([
    "1", "200", "TEST2", "G", "A", "benign",
    "criteria", "1", "Disease B", "AR", "c.200G>A", "p.Arg200Gln"
]) + "\n"
...
class MockPolars:
    ...
    def read_csv(self, *args, **kwargs):
        ...
        if "new_columns" in kwargs: # load_genome uses new_columns
            ...
            return MockPolarsDataFrame([
                {
                    "chrom": 1, "pos": 100, "symbol": "TEST1", "ref": "A", "alt": "G",
                    "clinical_significance": "pathogenic", "review_status": "criteria",
                    "gold_stars": 1, "pos_key": "1:100" # Simulate the added column
                },
                {
                    "chrom": 1, "pos": 200, "symbol": "TEST2", "ref": "G", "alt": "A",
                    "clinical_significance": "benign", "review_status": "criteria",
                    "gold_stars": 1, "pos_key": "1:200"
                }
            ])
