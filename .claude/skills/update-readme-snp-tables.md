...
- `scripts/traits_snp_database.py` (TRAITS_SNPS)
...
2. Update the three tables in the `## What It Analyzes` section of `README.md`:
   ...
   - **Observable Traits SNPs** table: from TRAITS_SNPS output, update the total count in the heading and all rows
